// Generated by dart2js, the Dart to JavaScript compiler version: 1.11.1.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    JSArray0: {
      ...
      indexOf$2: function(receiver, element, start) {
        var t1, i;
        t1 = J.getInterceptor$in(start);
        if (t1.$ge(start, receiver.length))
          return -1;
        if (t1.$lt(start, 0))
          start = 0;
        for (i = start; J.$lt$in(i, receiver.length); ++i) {
    ...
    JSInt: {
      ...
      $isnum: 1,
      $is$int: 1,
      static: {JSInt__binaryGcd: function(x, y, inv) {
    ...
    BigIntegerDartvm: {
      ...
      fromByteArray$2: function(s, fixsign) {
        var t1, v, t2;
        if (s == null || J.get$length$asx(s) === 0) {
          this.data = 0;
          return;
        }
      ...
      toByteArray$0: function() {
        ...
        if (neg) {
          ...
          if (J.$ge$in(byte0, 0)) {
            t1 = Array(blen + 1);
            t1.fixed$length = Array;
            bytes = H.setRuntimeTypeInfo(t1, [P.$int]);
            t1 = bytes.length;
            if (0 >= t1)
      ...
      }, "call$1", "get$min", 2, 0, 8, 18],
      max$1: [function(_, a) {
        return J.$gt$n(this.compareTo$1(0, a), 0) ? this : a;
      }, "call$1", "get$max", 2, 0, 8, 18],
      ...
      $ge: function(_, other) {
        return J.$ge$in(this.compareTo$1(0, other), 0) && true;
      },
      $eq: function(_, other) {
        if (other == null)
          return false;
    ...
    Classic: {
      ...
      convert$1: function(x) {
        if (J.$lt$in(x.s, 0) || J.$ge$in(x.compareTo$1(0, this.m), 0))
    ...
    Montgomery: {
      ...
      reduce$1: function(_, x) {
        ...
        while (true) {
          ...
          for (; J.$ge$in(J.$index$asx(x_array.data, j), $.BigIntegerV8_BI_DV);) {
        ...
        if (J.$ge$in(t2.compareTo$1(x, t1), 0))
          x.subTo$2(t1, x);
      },
      sqrTo$2: function(x, r) {
        x.squareTo$1(r);
    ...
    Barrett: {
      ...
      reduce$1: function(_, x) {
        ...
        x.subTo$2(this.r2, x);
        for (; J.$ge$in(t2.compareTo$1(x, t1), 0);)
          x.subTo$2(t1, x);
      },
      sqrTo$2: function(x, r) {
        x.squareTo$1(r);
    ...
    BigIntegerV8: {
      ...
      _am3$6: [function(i, x, w, j, c, n) {
        ...
        for (; n = J.$sub$n(n, 1), J.$ge$in(n, 0); j = j0, i = i0) {
        ...
        return c;
      }, "call$6", "get$_am3", 12, 0, 9, 19, 4, 20, 21, 22, 23],
      copyTo$1: function(r) {
      ...
      squareTo$1: function(r) {
        ...
        while (true) {
          ...
          if (J.$ge$in(t5, $.BigIntegerV8_BI_DV)) {
            t1 = x.t;
            if (typeof t1 !== "number")
              return H.iae(t1);
            t1 = i + t1;
      ...
      divRemTo$3: function(m, q, r) {
        ...
        if (J.$ge$in(t3.compareTo$1(r, t), 0)) {
          t4 = r.get$t();
          if (typeof t4 !== "number")
            return t4.$add();
          r.set$t(t4 + 1);
      ...
      toByteArray$0: function() {
        var this_array, i, r, t1, p, i0, d, t2, k, k0;
        this_array = this.array;
        i = this.t;
      ...
      min$1: [function(_, a) {
        return J.$lt$in(this.compareTo$1(0, a), 0) ? this : a;
      }, "call$1", "get$min", 2, 0, 10, 18],
      max$1: [function(_, a) {
        return J.$gt$n(this.compareTo$1(0, a), 0) ? this : a;
      }, "call$1", "get$max", 2, 0, 10, 18],
      ...
      dAddOffset$2: function(n, w) {
        ...
        for (; J.$ge$in(J.$index$asx(this_array.data, w), $.BigIntegerV8_BI_DV);) {
      ...
      modInverse$1: function(_, m) {
        ...
        for (t2 = ac === true, t3 = J.getInterceptor$i(u); u.signum$0() !== 0;) {
          ...
          if (J.$ge$in(t3.compareTo$1(u, v), 0)) {
            u.subTo$2(v, u);
            if (t2)
              r.subTo$2(r1, r);
            r0.subTo$2(r2, r0);
        ...
        if (J.$ge$in(r2.compareTo$1(0, m), 0)) {
          t2 = r2.subtract$1(m);
    ...
    ECPrivateKey: {
      ...
      get$hashCode: function(_) {
        return J.$add$ns(J.get$hashCode$(this.parameters), H.Primitives_objectHashCode(this.d));
      }
    },
    ECPublicKey: {
      ...
      get$hashCode: function(_) {
        return J.$add$ns(J.get$hashCode$(this.parameters), J.get$hashCode$(this.Q));
      }
    }
    ...
    _subWord: function(x) {
      ...
      if (t3 >>> 0 !== t3 || t3 >= t1.length)
        return H.ioore(t1, t3);
      t3 = J.$and$n(t1[t3], 255);
      t4 = J.$and$n(t2.$shr(x, 8), 255);
      if (t4 >>> 0 !== t4 || t4 >= t1.length)
        return H.ioore(t1, t4);
      t4 = J.$or$n(t3, J.$shl$n(J.$and$n(t1[t4], 255), 8));
      t3 = J.$and$n(t2.$shr(x, 16), 255);
      if (t3 >>> 0 !== t3 || t3 >= t1.length)
        return H.ioore(t1, t3);
      t3 = J.$or$n(t4, J.$shl$n(J.$and$n(t1[t3], 255), 16));
      t2 = J.$and$n(t2.$shr(x, 24), 255);
      if (t2 >>> 0 !== t2 || t2 >= t1.length)
        return H.ioore(t1, t2);
      return J.$or$n(t3, J.$shl$n(t1[t2], 24));
    },
    AESFastEngine: {
      ...
      init$2: function(forEncryption, params) {
        ...
        t1 = key.buffer;
        t1.toString;
        keyView = H.NativeByteData_NativeByteData$view(t1, 0, null);
        i = 0;
        t = 0;
        while (true) {
          t1 = key.byteLength;
      ...
      processBlock$4: function(inp, inpOff, out, outOff) {
        ...
        t1 = inp.buffer;
        t1.toString;
        inpView = H.NativeByteData_NativeByteData$view(t1, 0, null);
        t1 = out.buffer;
        t1.toString;
        outView = H.NativeByteData_NativeByteData$view(t1, 0, null);
      ...
      _encryptBlock$1: function(KW) {
        ...
        while (true) {
          ...
          t8 = t1[t8];
          t6 = J.$and$in(J.$shr$n(this._C2, 8), 255);
          if (t6 >>> 0 !== t6 || t6 >= 256)
            return H.ioore(t3, t6);
          t6 = t3[t6];
          t4 = J.$and$in(J.$shr$n(this._C3, 16), 255);
          if (t4 >>> 0 !== t4 || t4 >= 256)
            return H.ioore(t5, t4);
          t4 = t5[t4];
          t2 = J.$and$in(J.$shr$n(this._C0, 24), 255);
          if (t2 >>> 0 !== t2 || t2 >= 256)
          ...
          if (t8 >>> 0 !== t8 || t8 >= 256)
            return H.ioore(t1, t8);
          t8 = t1[t8];
          t6 = J.$and$in(J.$shr$n(this._C0, 8), 255);
          if (t6 >>> 0 !== t6 || t6 >= 256)
            return H.ioore(t3, t6);
          t6 = t3[t6];
          t4 = J.$and$in(J.$shr$n(this._C1, 16), 255);
          if (t4 >>> 0 !== t4 || t4 >= 256)
            return H.ioore(t5, t4);
          t4 = t5[t4];
          t2 = J.$and$in(J.$shr$n(this._C2, 24), 255);
          if (t2 >>> 0 !== t2 || t2 >= 256)
            return H.ioore(t7, t2);
          t2 = t7[t2];
          if (r >= KW.length)
        ...
        t1 = J.$xor$n(t3, J.$shl$n(J.$and$in(t5[t1], 255), 8));
        t3 = r2 >>> 16 & 255;
        if (t3 >= t5.length)
          return H.ioore(t5, t3);
        t3 = J.$xor$n(t1, J.$shl$n(J.$and$in(t5[t3], 255), 16));
        t1 = r3 >>> 24 & 255;
        if (t1 >= t5.length)
          return H.ioore(t5, t1);
        t1 = J.$xor$n(t3, J.$shl$n(t5[t1], 24));
        if (r >= KW.length)
          return H.ioore(KW, r);
        ...
        if (t3 >= t5.length)
          return H.ioore(t5, t3);
        t3 = J.$xor$n(t1, J.$shl$n(J.$and$in(t5[t3], 255), 8));
        t1 = r3 >>> 16 & 255;
        if (t1 >= t5.length)
          return H.ioore(t5, t1);
        t1 = J.$xor$n(t3, J.$shl$n(J.$and$in(t5[t1], 255), 16));
        t3 = r0 >>> 24 & 255;
        if (t3 >= t5.length)
          return H.ioore(t5, t3);
        t3 = J.$xor$n(t1, J.$shl$n(t5[t3], 24));
        if (r >= KW.length)
          return H.ioore(KW, r);
    ...
    ECCurveBase: {
      ...
      decodePoint$1: function(encoded) {
        ...
        expectedLength = C.JSNumber_methods._tdivFast$1(J.$add$ns(this.get$fieldSize(), 7), 8);
    ...
    _WNafMultiplier: [function(p, k, preCompInfo) {
      ...
      return q;
    }, "call$3", "_WNafMultiplier$closure", 6, 0, 56, 24, 25, 26],
    ...
    ECKeyGenerator: {
      ...
      generateKeyPair$0: function() {
        ...
        t1 = this._params;
        return new S.AsymmetricKeyPair(new Q.ECPublicKey($Q, t1), new Q.ECPrivateKey(d, t1));
      }
    }
    ...
    }, "call$1", "_AsyncRun__scheduleImmediateJsOverride$closure", 2, 0, 57],
    _AsyncRun__scheduleImmediateWithSetImmediate: [function(callback) {
      ++init.globalState.topEventLoop._activeJsAsyncCount;
      self.setImmediate(H.convertDartClosureToJS(new P._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback(callback), 0));
    }, "call$1", "_AsyncRun__scheduleImmediateWithSetImmediate$closure", 2, 0, 57],
    _AsyncRun__scheduleImmediateWithTimer: [function(callback) {
      P.Timer__createTimer(C.Duration_0, callback);
    }, "call$1", "_AsyncRun__scheduleImmediateWithTimer$closure", 2, 0, 57],
    ...
    }, "call$1", "_nullDataHandler$closure", 2, 0, 13, 17],
    ...
    }, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 17, 28, 12, 13],
    ...
    _AsBroadcastStreamController: {
      ...
      }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 15, 28, 12, 13],
      close$0: [function(_) {
        var t1 = this._state;
        if ((t1 & 4) === 0 && (t1 & 2) !== 0) {
    ...
    _Completer: {
      ...
      }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 15, 28, 12, 13]
    },
    _AsyncCompleter: {
      "^": "_Completer;future",
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 17, 28, 12, 13],
    ...
    _Future__chainForeignFuture_closure0: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 28, 12, 13, "call"]
    },
    ...
    _Future__propagateToListeners_handleWhenCompleteCallback_closure0: {
      "^": "Closure:18;_async$_box_0,_captured_result_12",
      call$2: [function(error, stackTrace) {
    ...
    Stream_contains__closure0: {
      "^": "Closure:20;_async$_box_0,_captured_future_6",
    ...
    _StreamIteratorImpl: {
      ...
      }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 15, 28, 12, 13],
      _onDone$0: [function() {
        if (this._state === 2) {
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 21, 12, 13],
    ...
    _defaultEquals: [function(a, b) {
      return J.$eq(a, b);
    }, "call$2", "_defaultEquals$closure", 4, 0, 58],
    _defaultHashCode: [function(a) {
      return J.get$hashCode$(a);
    }, "call$1", "_defaultHashCode$closure", 2, 0, 54, 18],
    ...
    LinkedList: {
      ...
      get$iterator: function(_) {
        return new P._LinkedListIterator(this, this._modificationCount, null, this._collection$_next);
      },
      get$length: function(_) {
        return this._collection$_length;
      },
    ...
    ListMixin: {
      ...
      indexOf$2: function(receiver, element, startIndex) {
        var t1, i;
        t1 = J.getInterceptor$in(startIndex);
        if (t1.$ge(startIndex, this.get$length(receiver)))
          return -1;
        if (t1.$lt(startIndex, 0))
          startIndex = 0;
        for (i = startIndex; t1 = J.getInterceptor$in(i), t1.$lt(i, this.get$length(receiver)); i = t1.$add(i, 1))
          if (J.$eq(this.$index(receiver, i), element))
            return i;
        return -1;
      },
    ...
    _ListQueueIterator: {
      ...
      static: {_ListQueueIterator$: function(queue) {
    ...
    }, "call$1", "_defaultToEncodable$closure", 2, 0, 59, 1],
    ...
    _JsonMap_addAll_closure: {
      "^": "Closure:11;_convert$_captured_this_0",
      call$2: [function(key, value) {
    ...
    _JsonStringStringifier: {
      ...
      static: {_JsonStringStringifier_stringify: function(object, toEncodable, indent) {
          ...
          if (indent == null)
            stringifier = new P._JsonStringStringifier(output, [], toEncodable);
          else
            stringifier = new P._JsonStringStringifierPretty(indent, 0, output, [], toEncodable);
    ...
    Utf8Encoder: {
      ...
      convert$3: function(string, start, end) {
        ...
        t2 = J.getInterceptor$in(stringLength);
    ...
    _Utf8Encoder: {
      ...
      _fillBuffer$3: function(str, start, end) {
        ...
        if (start !== end && (J.codeUnitAt$1$s(str, J.$sub$in(end, 1)) & 64512) === 55296)
          end = J.$sub$in(end, 1);
        if (typeof end !== "number")
          return H.iae(end);
        t1 = this._buffer;
    ...
    _Utf8Decoder: {
      ...
      convert$3: function(codeUnits, startIndex, endIndex) {
        ...
        $loop$0:
          for (t3 = this._stringSink, t4 = !this._allowMalformed, t5 = codeUnits.length, i = startIndex; true; i = i0) {
            $multibyte$2:
              if (expectedUnits > 0) {
                do {
                  if (i === endIndex)
            ...
            for (; i < endIndex; i = i0, value = 65533, expectedUnits = 0, extraUnits = 0) {
    ...
    _Utf8Decoder_convert_scanOneByteCharacters: {
      "^": "Closure:22;_captured_endIndex_0",
      call$2: function(units, from) {
        var to, t1, i, unit;
        to = this._captured_endIndex_0;
        for (t1 = units.length, i = from; i < to; ++i) {
          if (i < 0 || i >= t1)
    ...
    }, "call$2", "identical$closure", 4, 0, 60],
    identityHashCode: [function(object) {
      return H.objectHashCode(object);
    }, "call$1", "identityHashCode$closure", 2, 0, 61],
    ...
    Uri: {
      ...
      static: {Uri__defaultPort: function(scheme) {
          ...
          if (state === 1)
            for (; index = J.$add$ns(t1._captured_index_5, 1), t1._captured_index_5 = index, J.$lt$in(index, t1._captured_end_0);) {
              $char = t2.codeUnitAt$1(uri, t1._captured_index_5);
              t1._captured_char_6 = $char;
              if ($char === 63 || $char === 35)
                break;
          ...
          if (t3 === 63) {
            ...
            t2 = J.getInterceptor$in(numberSignIndex);
          ...
          if (!strictIPv6)
            for (i = start; t1 = J.getInterceptor$in(i), t1.$lt(i, end); i = t1.$add(i, 1))
          ...
          for (t1 = J.getInterceptor$s(host), index = start, sectionStart = index, buffer = null, isNormalized = true; t2 = J.getInterceptor$in(index), t2.$lt(index, end);) {
            ...
            if ($char === 37) {
              ...
              if (t3) {
                ...
                if (t3)
                  ...
                  if (($char & 64512) === 55296 && J.$lt$in(t2.$add(index, 1), end)) {
          ...
          if (J.$ge$in(t1.$add(index, 2), t2.get$length(source)))
            return "%";
          ...
          for (t1 = J.getInterceptor$s(component), index = start, sectionStart = index, buffer = null; t2 = J.getInterceptor$in(index), t2.$lt(index, end);) {
          ...
          if (J.$lt$in(J.get$length$asx(host), 2))
            error.call$1("address is too short");
          parts = [];
          partStart = start;
          for (i = start, wildcardSeen = false; t1 = J.getInterceptor$in(i), t1.$lt(i, end); i = J.$add$ns(i, 1))
    ...
    Uri_parse_parseAuth: {
      ...
      call$0: function() {
        ...
        for ($char = this._captured_EOI_2, lastColon = -1, lastAt = -1; J.$lt$in(t1._captured_index_5, t1._captured_end_0);) {
        ...
        t4 = J.getInterceptor$in(lastAt);
        if (t4.$ge(lastAt, 0)) {
          t1._captured_userinfo_2 = P.Uri__makeUserInfo(t2, authStart, lastAt);
          hostStart = t4.$add(lastAt, 1);
        } else
          hostStart = authStart;
        t4 = J.getInterceptor$in(lastColon);
        if (t4.$ge(lastColon, 0)) {
          if (J.$lt$in(t4.$add(lastColon, 1), t1._captured_index_5))
            for (i = t4.$add(lastColon, 1), portNumber = 0; t4 = J.getInterceptor$in(i), t4.$lt(i, t1._captured_index_5); i = t4.$add(i, 1)) {
        ...
        if (J.$lt$in(t1._captured_index_5, t1._captured_end_0))
    ...
    Uri_parseIPv6Address_parseHex: {
      "^": "Closure:29;_captured_host_1,_captured_error_2",
      call$2: function(start, end) {
        var value, t1;
        if (J.$gt$n(J.$sub$in(end, start), 4))
    ...
    AreaElement: {
      "^": "HtmlElement;coords=,hostname=,href},port=,protocol=",
      toString$0: function(receiver) {
        return String(receiver);
      },
      $isInterceptor: 1,
    ...
    Element: {
      ...
      }, "createFragment$2$treeSanitizer", null, null, "get$createFragment", 2, 5, null, 28, 28],
    ...
    InputElement: {
      "^": "HtmlElement;list=,max=,min=,name=,value=",
      $isElement: 1,
      $isInterceptor: 1,
      $isNode: 1,
      "%": "HTMLInputElement"
    ...
    _Html5NodeValidator: {
      ...
      static: {_Html5NodeValidator$: function(uriPolicy) {
          ...
          return true;
        }, "call$4", "_Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 62, 32, 37, 17, 38], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          var t1, t2, t3, t4, t5;
          ...
          if (!t1)
            ...
            t1 = true;
          return t1;
        }, "call$4", "_Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 62, 32, 37, 17, 38]}
    },
    ImmutableListMixin: {
      "^": "Object;",
      get$iterator: function(receiver) {
    ...
    _ValidatingTreeSanitizer_sanitizeTree_walk: {
      "^": "Closure:30;_html$_captured_this_0",
    ...
    }, null, null, 8, 0, null, 42, 43, 44, 45],
    ...
    }, "call$1", "_convertToJS$closure", 2, 0, 2, 46],
    ...
    }, "call$1", "_convertToDart$closure", 2, 0, 59, 46],
    ...
    "^": "",
    LinkProvider: {
      "^": "Object;link,defaultNodes,profiles,loadNodes,provider,dataStore,privateKey,brokerUrl,prefix,isRequester,isResponder,_initCalled",
      init$0: function() {
        var $goto = 0, completer = new P.Completer_Completer(), handler = 1, currentError, $self = this, t1, t2, t3, t4, t5, t6, temp1, temp2;
          ...
          while (true)
            switch ($goto) {
              case 0:
                ...
                temp1 = $self;
                $goto = 2;
                return H.asyncHelper(Y.getPrivateKey($self.dataStore), init$0, completer);
              case 2:
                // returning from await.
                temp1.privateKey = result;
                t1 = $self.provider;
                if (t1 == null) {
                  t1 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, T.LocalNode);
                  t2 = new T.SimpleNodeProvider(t1, null, null, null, P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, {func: 1, ret: T.SimpleNode, args: [P.String]}), new T.DummyPermissionManager());
                  ...
                  t3 = new T.SimpleNode(t2, false, true, false, null, null, "/", t3, null, null, t4, t5, t6);
                  t2.root = t3;
                  t1.$indexSet(0, "/", t3);
                  t3 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.Function, P.$int);
                  t4 = P.LinkedHashMap__makeEmpty();
                  t5 = P.LinkedHashMap__makeLiteral(["$is", "node"]);
                  t6 = P.LinkedHashMap__makeEmpty();
                  t3 = new T.SimpleHiddenNode(t2, false, true, false, null, null, "/defs", t3, null, null, t4, t5, t6);
                  t5.$indexSet(0, "$hidden", true);
                  t2.defs = t3;
                  t1.$indexSet(0, "/defs", t3);
                  t3 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.Function, P.$int);
                  t5 = P.LinkedHashMap__makeEmpty();
                  t4 = P.LinkedHashMap__makeLiteral(["$is", "node"]);
                  t6 = P.LinkedHashMap__makeEmpty();
                  t3 = new T.SimpleHiddenNode(t2, false, true, false, null, null, "/sys", t3, null, null, t5, t4, t6);
                  t4.$indexSet(0, "$hidden", true);
                  t2.sys = t3;
                  t1.$indexSet(0, "/sys", t3);
                  t2.init$2(null, $self.profiles);
                  $self.provider = t2;
                  t1 = t2;
                } else
                  ;
                $goto = $self.loadNodes && !!J.getInterceptor(t1).$isSerializableNodeProvider ? 3 : 5;
                break;
              case 3:
                // then
                $goto = 6;
                return H.asyncHelper($self.dataStore.has$1("dsa_nodes"), init$0, completer);
              case 6:
                // returning from await.
                t1 = result;
                t2 = $self.provider;
              ...
              case 9:
                ...
                temp2 = P;
                $goto = 10;
                return H.asyncHelper($self.dataStore.$get$1("dsa_nodes"), init$0, completer);
              case 10:
                // returning from await.
                temp1.init$1(temp2._parseJson(result, $.get$DsJson_instance().decoder._reviver));
              case 8:
                // join
                // goto join
                $goto = 4;
        ...
        return H.asyncHelper(null, init$0, completer, null);
      },
      connect$0: function() {
    ...
    LinkProvider_connect_run: {
      "^": "Closure:16;_browser$_captured_this_0",
      call$0: function() {
        var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10;
        t1 = this._browser$_captured_this_0;
        t2 = t1.privateKey;
        t3 = t1.provider;
        t4 = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [L.Requester])), [L.Requester]);
        t5 = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
        t6 = H.setRuntimeTypeInfo(Array(3), [P.String]);
        t7 = t1.prefix + t2.get$publicKey().get$qHash64();
        if (t1.isRequester) {
          t8 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, L.Request);
          t9 = new L.RemoteNodeCache(P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, L.RemoteNode));
          t9 = new L.Requester(t8, t9, null, 1, 1, 0, false, null, null, null, H.setRuntimeTypeInfo([], [P.Map]), [], false);
          t8 = L.SubscribeRequest$(t9, 0);
          t9._subsciption = t8;
          t9._requests.$indexSet(0, 0, t8);
          t8 = t9;
        } else
          t8 = null;
        if (t1.isResponder && t3 != null) {
          t9 = P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, T.Response);
          t3 = new T.Responder(null, [], t9, null, t3, null, null, null, null, H.setRuntimeTypeInfo([], [P.Map]), [], false);
          t10 = new T.SubscribeResponse(P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, T.RespSubscribeController), P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, T.RespSubscribeController), P.LinkedHashSet_LinkedHashSet(null, null, null, T.RespSubscribeController), 0, -1, false, t3, 0, "initialize", false);
          t3._responder$_subscription = t10;
          t9.$indexSet(0, 0, t10);
        } else
          t3 = null;
        t6 = new Y.BrowserECDHLink(t4, t5, t7, t8, t3, t2, null, null, false, t6, null, null, t1.brokerUrl, 1, 1, false);
        t1.link = t6;
        t6.connect$0();
        return t1.link._onConnectedCompleter.future;
      }
    },
    ...
    getPrivateKey: function(storage) {
      ...
      function getPrivateKey(errorCode, result) {
        if (errorCode === 1) {
          currentError = result;
          $goto = handler;
        }
          ...
          switch ($goto) {
            case 0:
              ...
              if (storage == null)
                ...
                ;
              $goto = 5;
              return H.asyncHelper(storage.has$1("dsa_key"), getPrivateKey, completer);
            case 5:
              // returning from await.
              $goto = result === true ? 3 : 4;
              break;
            case 3:
              // then
              $goto = 6;
              return H.asyncHelper(storage.$get$1("dsa_key"), getPrivateKey, completer);
            case 6:
              // returning from await.
              t1 = result;
              $returnValue = $.get$_CRYPTO_PROVIDER().loadFromString$1(t1);
              // goto return
              $goto = 1;
              break;
            case 4:
              // join
              $goto = 7;
              return H.asyncHelper(K.PrivateKey_generate(), getPrivateKey, completer);
            case 7:
              // returning from await.
              key = result;
              $goto = 8;
              return H.asyncHelper(storage.store$2("dsa_key", key.saveToString$0()), getPrivateKey, completer);
            case 8:
              // returning from await.
              $returnValue = key;
              // goto return
    ...
    LocalDataStorage: {
      ...
      $get$1: function(key) {
        ...
        function $$get$1(errorCode, result) {
          if (errorCode === 1) {
            currentError = result;
            $goto = handler;
          }
        ...
        return H.asyncHelper(null, $$get$1, completer, null);
      },
      has$1: function(key) {
        var $goto = 0, completer = new P.Completer_Completer(), $returnValue, handler = 2, currentError;
        function has$1(errorCode, result) {
          if (errorCode === 1) {
            currentError = result;
            $goto = handler;
          }
          while (true)
            switch ($goto) {
              case 0:
                // Function start
                $returnValue = window.localStorage.getItem(key) != null;
                // goto return
                $goto = 1;
                break;
              case 1:
        ...
        return H.asyncHelper(null, has$1, completer, null);
      },
      store$2: function(key, value) {
        var $goto = 0, completer = new P.Completer_Completer(), $returnValue, handler = 2, currentError;
        function store$2(errorCode, result) {
          if (errorCode === 1) {
            currentError = result;
            $goto = handler;
          }
        ...
        return H.asyncHelper(null, store$2, completer, null);
      },
      remove$1: function(_, key) {
        var $goto = 0, completer = new P.Completer_Completer(), $returnValue, handler = 2, currentError, t1;
        function remove$1(errorCode, result) {
          if (errorCode === 1) {
            currentError = result;
            $goto = handler;
          }
          while (true)
            switch ($goto) {
              case 0:
                ...
                $returnValue = (t1 && C.Storage_methods).remove$1(t1, key);
                // goto return
                $goto = 1;
                break;
              case 1:
    ...
    BrowserECDHLink: {
      "^": "Object;_onRequesterReadyCompleter,_onConnectedCompleter,dsId,requester,responder,privateKey,_nonce,_wsConnection,enableAck,salts,_wsUpdateUri,_httpUpdateUri,_conn,_connDelay,_wsDelay,_closed",
      get$onConnected: function() {
        return this._onConnectedCompleter.future;
      },
      connect$0: [function() {
        var $goto = 0, completer = new P.Completer_Completer(), $returnValue, handler = 2, currentError, next = [], $self = this, connUri, requestJson, request, serverConfig, tempKey, t1, t2, t3, t4, exception, exception1, temp1;
          ...
          while (true)
            switch ($goto) {
              case 0:
                ...
                t1 = $self.dsId;
                connUri = P.Uri_parse($self._conn + "?dsId=" + t1, 0, null);
                Q.logger().info$1("Connecting: " + H.S(connUri));
                handler = 4;
                t2 = $self.privateKey;
                requestJson = P.LinkedHashMap__makeLiteral(["publicKey", t2.get$publicKey().get$qBase64(), "isRequester", $self.requester != null, "isResponder", $self.responder != null, "version", "1.0.4"]);
                t3 = J.toString$0(connUri);
                t4 = $.get$DsJson_instance();
                t4 = t4.encoder;
                $goto = 7;
                return H.asyncHelper(W.HttpRequest_request(t3, "POST", "application/json", null, null, null, P._JsonStringStringifier_stringify(requestJson, t4._toEncodable, t4.indent), false), connect$0, completer);
              case 7:
                // returning from await.
                request = result;
                serverConfig = P._parseJson(J.get$responseText$x(request), $.get$DsJson_instance().decoder._reviver);
                C.Map_gVGBQ.forEach$1(0, new Y.BrowserECDHLink_connect_closure($self, serverConfig));
              ...
              case 8:
                ...
                if (typeof t2 === "string") {
                  t2 = connUri.resolveUri$1(P.Uri_parse(J.$index$asx(serverConfig, "wsUri"), 0, null)).toString$0(0) + "?dsId=" + t1;
                  H.checkString("ws");
                  H.checkInt(0);
                ...
                if (typeof t2 === "string")
                  $self._httpUpdateUri = connUri.resolveUri$1(P.Uri_parse(J.$index$asx(serverConfig, "httpUri"), 0, null)).toString$0(0) + "?dsId=" + t1;
                else
                  ;
                $self.enableAck = J.containsKey$1$x(serverConfig, "version");
      ...
      }, "call$0", "get$connect", 0, 0, 0],
      initWebsocket$1: [function(reconnect) {
        var socket, t1, t2, t3, t4;
        if (this._closed)
          return;
        socket = W.WebSocket_WebSocket(H.S(this._wsUpdateUri) + "&auth=" + this._nonce.hashSalt$1(this.salts[0]), null);
        t1 = this.enableAck;
        t2 = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [O.ConnectionChannel])), [O.ConnectionChannel]);
        t3 = new Y.WebSocketConnection(null, null, t2, H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [P.bool])), [P.bool]), this, socket, new Y.BrowserECDHLink_initWebsocket_closure(this), null, false, 0, false, null, new Q.BinaryInCache(P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, Q.BinaryData)), new Q.BinaryOutCache(0, P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, Q.BinaryData)), 0, false, false, P.ListQueue$(null, O.ConnectionAckGroup));
        if (t1 !== true)
          t3.msgId = -1;
        socket.binaryType = "arraybuffer";
        t3._responderChannel = new O.PassiveChannel(P.StreamController_StreamController(null, null, null, null, false, P.List), [], t3, null, false, false, H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [O.ConnectionChannel])), [O.ConnectionChannel]), H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [O.ConnectionChannel])), [O.ConnectionChannel]));
        t3._requesterChannel = new O.PassiveChannel(P.StreamController_StreamController(null, null, null, null, false, P.List), [], t3, null, false, false, H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [O.ConnectionChannel])), [O.ConnectionChannel]), H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [O.ConnectionChannel])), [O.ConnectionChannel]));
        t1 = H.setRuntimeTypeInfo(new W._EventStream(socket, "message", false), [null]);
        t4 = t3.get$_browser_client$_onData();
        t3.get$_browser_client$_onDone();
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(t4), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = H.setRuntimeTypeInfo(new W._EventStream(socket, "close", false), [null]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(t3.get$_browser_client$_onDone()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = H.setRuntimeTypeInfo(new W._EventStream(socket, "open", false), [null]);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(t3.get$_onOpen()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = t3._requesterChannel;
        t4 = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
        t4._asyncComplete$1(t1);
        t2.complete$1(0, t4);
        t3.pingTimer = P.Timer_Timer$periodic(P.Duration$(0, 0, 0, 0, 0, 20), t3.get$onPingTimer());
        this._wsConnection = t3;
        t1 = this.responder;
        if (t1 != null)
          t1.set$connection(0, t3._responderChannel);
        if (this.requester != null)
          this._wsConnection._onRequestReadyCompleter.future.then$1(new Y.BrowserECDHLink_initWebsocket_closure0(this));
      ...
      }, "initWebsocket$0", "call$1", "call$0", "get$initWebsocket", 0, 2, 31, 47, 48],
      close$0: function(_) {
        var t1;
    ...
    BrowserECDHLink_connect_closure: {
      "^": "Closure:11;_browser_client$_captured_this_0,_captured_serverConfig_1",
      call$2: function($name, idx) {
        var t1, t2, t3;
        t1 = this._browser_client$_captured_this_0.salts;
        t2 = idx;
        t3 = J.$index$asx(this._captured_serverConfig_1, $name);
        if (t2 >>> 0 !== t2 || t2 >= 3)
          return H.ioore(t1, t2);
        t1[t2] = t3;
      }
    ...
    BrowserECDHLink_initWebsocket_closure: {
      ...
      call$0: function() {
        var t1 = this._browser_client$_captured_this_0._onConnectedCompleter;
    ...
    BrowserECDHLink_initWebsocket_closure1: {
      ...
      call$1: [function(authError) {
        ...
        if (t1._wsConnection._opened) {
          ...
          Q.DsTimer_timerOnceAfter(t1.get$initWebsocket(), t1._wsDelay * 1000);
          t2 = t1._wsDelay;
          if (t2 < 60)
            t1._wsDelay = t2 + 1;
        } else {
    ...
    WebSocketConnection: {
      ...
      _browser_client$_onData$1: [function(e) {
        ...
        if (!!J.getInterceptor(J.get$data$x(e)).$isByteBuffer)
          try {
            ...
            t1 = new P.Utf8Decoder(false).convert$1(bytes);
            m = $.get$DsJson_instance().decodeJsonFrame$2(t1, this.binaryInCache);
            Q.logger().fine$1(H.S(m));
            t1 = J.$index$asx(m, "salt");
            if (typeof t1 === "string")
              this.clientLink.salts[0] = J.$index$asx(m, "salt");
            needAck = false;
            if (!!J.getInterceptor(J.$index$asx(m, "responses")).$isList && J.get$length$asx(H.listTypeCast(J.$index$asx(m, "responses"))) > 0) {
              needAck = true;
              t1 = this._requesterChannel.onReceiveController;
              t2 = J.$index$asx(m, "responses");
              if (t1._state >= 4)
                H.throwExpression(t1._badEventState$0());
              t1._async$_add$1(t2);
            }
            if (!!J.getInterceptor(J.$index$asx(m, "requests")).$isList && J.get$length$asx(H.listTypeCast(J.$index$asx(m, "requests"))) > 0) {
              needAck = true;
              t1 = this._responderChannel.onReceiveController;
              t2 = J.$index$asx(m, "requests");
              if (t1._state >= 4)
                H.throwExpression(t1._badEventState$0());
              t1._async$_add$1(t2);
            }
      ...
      }, "call$1", "get$_browser_client$_onData", 2, 0, 34, 3],
      _send$0: [function() {
        var t1, m, needSend, pendingAck, t2, rslt, t3, json;
        this._sending = false;
        t1 = this.socket;
        if (t1.readyState !== 1)
          return;
        ...
        pendingAck = [];
        t2 = Date.now();
        rslt = this._responderChannel.getSendingData$2(t2, this.msgId);
        if (rslt != null) {
          t3 = rslt.messages;
          if (t3.length > 0) {
            m.$indexSet(0, "responses", t3);
            needSend = true;
          }
          t3 = rslt.processors;
          if (t3.length > 0)
            C.JSArray_methods.addAll$1(pendingAck, t3);
        }
        rslt = this._requesterChannel.getSendingData$2(t2, this.msgId);
        if (rslt != null) {
          t3 = rslt.messages;
          if (t3.length > 0) {
            m.$indexSet(0, "requests", t3);
            needSend = true;
          }
          t3 = rslt.processors;
          if (t3.length > 0)
        ...
        if (needSend) {
          ...
          if (t3 !== -1) {
            if (pendingAck.length > 0)
              this.pendingAcks._add$1(new O.ConnectionAckGroup(t3, t2, null, pendingAck));
            m.$indexSet(0, "msg", this.msgId++);
          }
          Q.logger().fine$1("send: " + H.S(m));
          t2 = this.binaryOutCache;
          json = $.get$DsJson_instance().encodeJsonFrame$3$pretty(m, t2, false);
          if (t2.caches.__js_helper$_length !== 0)
            t1.send(t2.export$0().buffer);
          t1.send(json);
          this._dataSent = true;
        }
      }, "call$0", "get$_send", 0, 0, 1],
      _browser_client$_onDone$1: [function(o) {
        ...
        if (t1.future._state === 0)
          t1.complete$1(0, this._authError);
        t1 = this.pingTimer;
        if (t1 != null)
          t1.cancel$0();
      }, function() {
        return this._browser_client$_onDone$1(null);
      }, "_browser_client$_onDone$0", "call$1", "call$0", "get$_browser_client$_onDone", 0, 2, 35, 28, 46],
      close$0: function(_) {
        var t1, t2;
        t1 = this.socket;
        t2 = t1.readyState;
    ...
    Connection: {
      ...
      ack$1: function(ackId) {
        var t1, t2, findAckGroup, ackGroup, t3;
        for (t1 = this.pendingAcks, t2 = P._ListQueueIterator$(t1), findAckGroup = null; t2.moveNext$0();) {
          ackGroup = t2._collection$_current;
          if (ackGroup.get$ackId() === ackId) {
            findAckGroup = ackGroup;
            break;
          } else {
            t3 = ackGroup.get$ackId();
        ...
        if (findAckGroup != null) {
          t2 = Date.now();
          do {
            ackGroup = t1.removeFirst$0();
            ackGroup.ackAll$2(ackId, t2);
    ...
    ProcessorResult: {
      "^": "Object;messages,processors"
    },
    ConnectionAckGroup: {
      "^": "Object;ackId<,startTime,expectedAckTime,processors",
      ackAll$2: function(ackid, time) {
        var t1, t2, t3, t4, _i;
        for (t1 = this.processors, t2 = t1.length, t3 = this.ackId, t4 = this.startTime, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
          t1[_i].ackReceived$3(t3, t4, time);
      }
    },
    ConnectionChannel: {
      "^": "Object;"
    ...
    DSError: {
      "^": "Object;type,detail',msg,path>,phase"
    },
    PassiveChannel: {
      "^": "Object;onReceiveController,_processors,conn,handler,_isReady,connected<,onDisconnectController,onConnectController",
      get$onReceive: function() {
        return H.setRuntimeTypeInfo(new P._ControllerStream(this.onReceiveController), [null]);
      },
    ...
    ConnectionHandler: {
      ...
      set$connection: function(_, conn) {
        ...
        if (t1 != null) {
          ...
          this._onDisconnected$1(this._common$_conn);
        }
        this._common$_conn = conn;
        this._connListener = conn.get$onReceive().listen$1(this.get$onData());
        this._common$_conn.get$onDisconnected().then$1(this.get$_onDisconnected());
        if (this._common$_conn.get$connected())
          this.onReconnected$0();
        else
          this._common$_conn.get$onConnected().then$1(new O.ConnectionHandler_connection_closure(this));
      },
      _onDisconnected$1: [function(conn) {
        var t1;
        if (J.$eq(this._common$_conn, conn)) {
      ...
      }, "call$1", "get$_onDisconnected", 2, 0, 36, 51],
      ...
      getSendingData$2: ["super$ConnectionHandler$getSendingData$2", function(currentTime, waitingAckId) {
        var processors, t1, _i, rslt;
        this._pendingSend = false;
        processors = this._processors;
        this._processors = [];
        for (t1 = processors.length, _i = 0; _i < processors.length; processors.length === t1 || (0, H.throwConcurrentModificationError)(processors), ++_i)
          processors[_i].startSendingData$2(currentTime, waitingAckId);
    ...
    Node0: {
      ...
      getAttribute$1: function(_, $name) {
        ...
        t1 = this.profile;
        if (t1 != null && J.get$attributes$x(t1).containsKey$1(0, $name) === true)
          return J.get$attributes$x(this.profile).$index(0, $name);
        return;
      },
      getConfig$1: function($name) {
        ...
        if (t1.containsKey$1(0, $name))
          return t1.$index(0, $name);
        t1 = this.profile;
        if (t1 != null && t1.get$configs().containsKey$1(0, $name))
          return this.profile.get$configs().$index(0, $name);
        return;
      },
      ...
      getChild$1: function($name) {
        ...
        if (t1.containsKey$1(0, $name))
          return t1.$index(0, $name);
        t1 = this.profile;
        if (t1 != null && J.containsKey$1$x(J.get$children$x(t1), $name))
      ...
      getSimpleMap$0: function() {
        ...
        t1 = this.configs;
        if (t1.containsKey$1(0, "$is"))
          rslt.$indexSet(0, "$is", t1.$index(0, "$is"));
        if (t1.containsKey$1(0, "$type"))
          rslt.$indexSet(0, "$type", t1.$index(0, "$type"));
        if (t1.containsKey$1(0, "$name"))
          rslt.$indexSet(0, "$name", t1.$index(0, "$name"));
        if (t1.containsKey$1(0, "$invokable"))
          rslt.$indexSet(0, "$invokable", t1.$index(0, "$invokable"));
        if (t1.containsKey$1(0, "$writable"))
          rslt.$indexSet(0, "$writable", t1.$index(0, "$writable"));
        return rslt;
      }
    },
    Path: {
      "^": "Object;path>,parentPath,name>,valid",
      get$parent: function(_) {
      ...
      mergeBasePath$1: function(base) {
        return this.mergeBasePath$2(base, false);
      },
      static: {Path_getValidPath: function(path, basePath) {
          var p;
    ...
    ValueUpdate: {
      "^": "Object;value>,ts<,status>,count<,sum<,min>,max>",
      ...
      static: {ValueUpdate_getTs: function() {
  ...
  }], ["dslink.mobile.init", "package:dslink_cordova/init.dart",, L, {
    "^": "",
    init: function() {
      var $goto = 0, completer = new P.Completer_Completer(), handler = 1, currentError, logElement, t1, t2, temp1;
      function $init(errorCode, result) {
        if (errorCode === 1) {
          currentError = result;
          $goto = handler;
        }
        while (true)
          switch ($goto) {
            case 0:
              ...
              temp1 = $;
              $goto = 2;
              return H.asyncHelper(t1, $init, completer);
            case 2:
              // returning from await.
              temp1.device0 = result;
              ...
              $.link = t1;
              $goto = 3;
              return H.asyncHelper(t1.connect$0(), $init, completer);
            case 3:
              // returning from await.
              $goto = 4;
              return H.asyncHelper(L.loadPlugins(), $init, completer);
            case 4:
              // returning from await.
              P.print("Connected.");
              // implicit return
      ...
      return H.asyncHelper(null, $init, completer, null);
    },
    NullNodeValidator: {
      "^": "Object;",
      allowsElement$1: function(element) {
    ...
    init_closure: {
      "^": "Closure:2;_captured_logElement_0",
      call$1: [function(record) {
        var t1, t2, t3;
        t1 = this._captured_logElement_0;
        t2 = J.getInterceptor$x(t1);
        t3 = t2.get$innerHtml(t1).split("<br/>");
        t2.setInnerHtml$2$validator(t1, H.SubListIterable$(t3, 0, 9, H.getTypeArgumentByIndex(t3, 0)).join$1(0, "<br/>") + "<br/>" + ("[" + record.get$level().name.toUpperCase() + "] " + H.S(J.get$message$x(record))), C.C_NullNodeValidator);
      }, null, null, 2, 0, null, 52, "call"]
    }
  }], ["dslink.mobile.main", "index.dart",, T, {
    "^": "",
    main: [function() {
        ...
        while (true)
          switch ($goto) {
            case 0:
              // Function start
              $goto = 2;
              return H.asyncHelper(L.init(), main, completer);
            case 2:
              // returning from await.
              // implicit return
              return H.asyncHelper(null, 0, completer, null);
  ...
  }, 1], ["dslink.mobile.plugins", "package:dslink_cordova/plugins.dart",, L, {
    "^": "",
    loadPlugins: function() {
      var $goto = 0, completer = new P.Completer_Completer(), handler = 1, currentError, t1, _i;
      function loadPlugins(errorCode, result) {
        if (errorCode === 1) {
          currentError = result;
          $goto = handler;
        }
        while (true)
          switch ($goto) {
            ...
            case 2:
              ...
              $goto = 5;
              return H.asyncHelper(t1[_i].init$0(), loadPlugins, completer);
            case 5:
              // returning from await.
            case 3:
              // for update
    ...
    createActionNode: function(path, handler, $name, params, permission, results, table) {
    ...
    BarcodeScannerPlugin: {
      "^": "Plugin;",
      init$0: function() {
        L.createActionNode("/Barcodes/Scan", new L.BarcodeScannerPlugin_init_closure($.get$context().callMethod$2("eval", ["cordova.plugins.barcodeScanner"])), null, null, "read", [P.LinkedHashMap__makeLiteral(["name", "text", "type", "string"]), P.LinkedHashMap__makeLiteral(["name", "format", "type", "string"]), P.LinkedHashMap__makeLiteral(["name", "cancelled", "type", "bool"])], false);
      }
    },
    BarcodeScannerPlugin_init_closure: {
      "^": "Closure:37;_captured_scanner_0",
      call$1: [function(params) {
        var $goto = 0, completer1 = new P.Completer_Completer(), $returnValue, handler = 2, currentError, $self = this, completer;
          ...
          while (true)
            switch ($goto) {
              case 0:
                ...
                $self._captured_scanner_0.callMethod$2("scan", [new L.BarcodeScannerPlugin_init__closure(completer), new L.BarcodeScannerPlugin_init__closure0(completer)]);
                $goto = 3;
                return H.asyncHelper(completer.future, call$1, completer1);
              case 3:
                // returning from await.
                $returnValue = result;
                // goto return
              ...
              case 1:
                // return
                return H.asyncHelper($returnValue, 0, completer1, null);
              case 2:
                // rethrow
                return H.asyncHelper(currentError, 1, completer1);
            }
        }
    ...
    BarcodeScannerPlugin_init__closure: {
      "^": "Closure:38;_plugins$_captured_completer_1",
      call$1: [function(result) {
    ...
    BarcodeScannerPlugin_init__closure0: {
      "^": "Closure:38;_plugins$_captured_completer_2",
      call$1: [function(error) {
    ...
    GeolocationPlugin: {
      "^": "Plugin;",
      init$0: function() {
        L.createActionNode("/Geolocation/getPosition", new L.GeolocationPlugin_init_closure(), "Get Position", null, "read", P.LinkedHashMap__makeLiteral(["latitude", "number", "longitude", "number", "altitude", "number", "accuracy", "number", "heading", "number", "speed", "number", "timestamp", "number"]), false);
      }
    },
    ...
    "^": "",
    SimpleActionNode: {
      "^": "SimpleNode;$function,provider,removed,serializable,_loaded,_listChangeController,_listReqListener,path,callbacks,_lastValueUpdate,profile,attributes,configs,children",
      onInvoke$1: function(params) {
        return this.function$1(params);
      },
  ...
  }], ["dslink.pk.dart", "package:dslink/src/crypto/dart/pk.dart",, G, {
    "^": "",
    bigintToUint8List: function(input) {
      var rslt, t1, len, i;
      rslt = input.toByteArray$0();
      t1 = J.getInterceptor$asx(rslt);
      if (J.$gt$n(t1.get$length(rslt), 32) && J.$eq(t1.$index(rslt, 0), 0))
    ...
    DartCryptoProvider: {
      "^": "Object;random,_cachedPrivate,_cachedPublic,_cachedTime",
      getSecret$1: function(publicKeyRemote) {
        var $goto = 0, completer = new P.Completer_Completer(), $returnValue, handler = 2, currentError, $self = this, gen, t1, rsapars, pair;
          ...
          while (true)
            switch ($goto) {
              case 0:
                ...
                gen.init$1(new A.ParametersWithRandom(rsapars, $self.random));
                pair = gen.generateKeyPair$0();
                t1 = pair.privateKey;
                $returnValue = G.ECDHImpl$(t1, pair.publicKey, J.$mul$ns(publicKeyRemote.get$ecPublicKey().Q, t1.d));
                // goto return
                $goto = 1;
                break;
              case 1:
          ...
          while (true)
            switch ($goto) {
              case 0:
                ...
                gen.init$1(new A.ParametersWithRandom(rsapars, $self.random));
                pair = gen.generateKeyPair$0();
                $returnValue = G.PrivateKeyImpl$(pair.privateKey, pair.publicKey);
                // goto return
                $goto = 1;
                break;
              case 1:
      ...
      loadFromString$1: function(str) {
        ...
        if (t1.contains$1(str, " ") === true) {
          ...
          if (1 >= ss.length)
            return H.ioore(ss, 1);
          return G.PrivateKeyImpl$(new Q.ECPrivateKey(d, t1), new Q.ECPublicKey(t2.decodePoint$1(Q.Base64_decode(ss[1])), $.get$_secp256r1()));
        } else
          return G.PrivateKeyImpl$(new Q.ECPrivateKey(Z.BigInteger_BigInteger$fromBytes(1, Q.Base64_decode(str)), $.get$_secp256r1()), null);
      }
    },
    ECDHImpl: {
      "^": "ECDH;bytes@,_ecPrivateKey,_ecPublicKey",
      hashSalt$1: function(salt) {
        ...
        sha256 = new K.SHA256Digest("SHA-256", 32, t1, t2, null, C.Endianness_false, 8, t3, H.setRuntimeTypeInfo(t4, [P.$int]), null);
      ...
      ECDHImpl$3: function(_ecPrivateKey, _ecPublicKey, Q2) {
        var t1, t2, newbytes, dlen, i, t3;
        t1 = G.bigintToUint8List(J.get$x$x(Q2).toBigInteger$0());
        this.bytes = t1;
        if (t1.length > 32) {
          t1 = this.bytes;
          t2 = J.getInterceptor$asx(t1);
      ...
      static: {ECDHImpl$: function(_ecPrivateKey, _ecPublicKey, Q2) {
          var t1 = new G.ECDHImpl(null, _ecPrivateKey, _ecPublicKey);
          t1.ECDHImpl$3(_ecPrivateKey, _ecPublicKey, Q2);
          return t1;
        }}
    },
    PublicKeyImpl: {
      "^": "PublicKey;ecPublicKey<,qBase64<,qHash64<"
    },
    PrivateKeyImpl: {
      "^": "Object;publicKey<,ecPrivateKey,ecPublicKey<",
      saveToString$0: function() {
        return Q.Base64_encode(G.bigintToUint8List(this.ecPrivateKey.d), 0, 0) + " " + this.publicKey.qBase64;
      },
      getSecret$1: function(key) {
        var $goto = 0, completer = new P.Completer_Completer(), $returnValue, handler = 2, currentError, $self = this, t1, p, Q2;
        function getSecret$1(errorCode, result) {
          if (errorCode === 1) {
            currentError = result;
            $goto = handler;
          ...
          while (true)
            switch ($goto) {
              case 0:
                // Function start
                t1 = $self.ecPrivateKey;
                p = t1.parameters.get$curve().decodePoint$1(Q.Base64_decode(key));
                $.get$_secp256r1();
                Q2 = p.$mul(0, t1.d);
                $returnValue = G.ECDHImpl$(t1, $self.ecPublicKey, Q2);
                // goto return
                $goto = 1;
                break;
              case 1:
      ...
      PrivateKeyImpl$2: function(ecPrivateKey, ecPublicKey) {
        var t1, t2, bytes, t3, t4, t5, sha256;
        t1 = this.ecPublicKey;
        if (t1 == null) {
          t1 = new Q.ECPublicKey($.get$_secp256r1().get$G().$mul(0, this.ecPrivateKey.d), $.get$_secp256r1());
          this.ecPublicKey = t1;
        }
        t2 = new G.PublicKeyImpl(t1, null, null);
        bytes = t1.Q.getEncoded$1(false);
        ...
        t4 = Array(8);
        t4.fixed$length = Array;
        t4 = H.setRuntimeTypeInfo(t4, [P.$int]);
        t5 = Array(64);
        t5.fixed$length = Array;
        sha256 = new K.SHA256Digest("SHA-256", 32, t1, t3, null, C.Endianness_false, 8, t4, H.setRuntimeTypeInfo(t5, [P.$int]), null);
        sha256.MD4FamilyDigest$4(C.Endianness_false, 8, 64, null);
        t2.qHash64 = Q.Base64_encode(sha256.process$1(bytes), 0, 0);
        this.publicKey = t2;
      },
      static: {PrivateKeyImpl$: function(ecPrivateKey, ecPublicKey) {
          var t1 = new G.PrivateKeyImpl(null, ecPrivateKey, ecPublicKey);
          t1.PrivateKeyImpl$2(ecPrivateKey, ecPublicKey);
          return t1;
        }}
    },
    DSRandomImpl: {
      ...
      DSRandomImpl$1: function(seed) {
        ...
        t2 = Date.now();
        r = P._Random$(t2);
        iv = new Uint8Array(H._ensureNativeList([r.nextInt$1(256), r.nextInt$1(256), r.nextInt$1(256), r.nextInt$1(256), r.nextInt$1(256), r.nextInt$1(256), r.nextInt$1(256), r.nextInt$1(256)]));
        this._delegate.seed$1(0, new Y.ParametersWithIV(iv, new E.KeyParameter(t1)));
      }
    }
    ...
    RemoteNodeCache: {
      ...
      getRemoteNode$1: function(path) {
        ...
        if (!t1.containsKey$1(0, path))
          if (J.startsWith$1$s(path, "defs")) {
            t2 = new L.RemoteDefNode(path, false, null, null, null, null, P.LinkedHashMap__makeEmpty(), P.LinkedHashMap__makeLiteral(["$is", "node"]), P.LinkedHashMap__makeEmpty());
            t2._getRawName$0();
            t1.$indexSet(0, path, t2);
          } else {
            t2 = new L.RemoteNode(path, false, null, null, null, null, P.LinkedHashMap__makeEmpty(), P.LinkedHashMap__makeLiteral(["$is", "node"]), P.LinkedHashMap__makeEmpty());
            t2._getRawName$0();
            t1.$indexSet(0, path, t2);
          }
    ...
    RemoteNode: {
      "^": "Node0;remotePath<,listed,name>,_listController,_subscribeController,profile,attributes,configs,children",
      ...
      _requester$_subscribe$3: function(requester, callback, cacheLevel) {
        ...
        if (t1 == null) {
          ...
          requester.nextSid = J.$add$ns(t2, 1);
          t1.sid = t2;
        ...
        t2 = t1.callbacks;
        if (t2.containsKey$1(0, callback)) {
          if (J.$eq(t2.$index(0, callback), t1.maxCache)) {
            t3 = t1.maxCache;
            if (typeof t3 !== "number")
              return H.iae(t3);
            t3 = cacheLevel < t3;
      ...
      _unsubscribe$2: function(requester, callback) {
        var t1, t2, cacheLevel, path, t3;
        t1 = this._subscribeController;
        if (t1 != null) {
          t2 = t1.callbacks;
          if (t2.containsKey$1(0, callback)) {
            cacheLevel = t2.remove$1(0, callback);
            if (t2.__js_helper$_length === 0) {
              t2 = t1.requester._subsciption;
              t2.toString;
              path = t1.node.remotePath;
              t3 = t2.subsriptions;
              if (t3.containsKey$1(0, path)) {
                t2.toRemove.$indexSet(0, t3.$index(0, path).get$sid(), t3.$index(0, path));
                t2.prepareSending$0();
              } else if (t2.subsriptionids.containsKey$1(0, t1.sid))
                Q.logger().severe$1("unexpected remoteSubscription in the requester, sid: " + H.S(t1.sid));
            } else if (J.$eq(cacheLevel, t1.maxCache) && J.$gt$n(t1.maxCache, 1))
              t1.updateCacheLevel$0();
          }
        }
      },
    ...
    RemoteNode_updateRemoteChildData_closure: {
      "^": "Closure:3;_requester$_box_0,_requester$_captured_this_1,_captured_cache_2",
      call$2: function(key, value) {
        var t1, node;
    ...
    RemoteDefNode: {
      "^": "RemoteNode;remotePath,listed,name,_listController,_subscribeController,profile,attributes,configs,children"
    },
    Request: {
      "^": "Object;requester,rid<,data>,updater<,_requester$_isClosed,streamStatus<",
      resend$0: function() {
    ...
    RequesterListUpdate: {
      "^": "RequesterUpdate;changes<,node<,streamStatus"
    },
    ListDefListener: {
      "^": "Object;node<,requester,listener,ready",
      ListDefListener$3: function(node, requester, callback) {
        this.listener = this.requester.list$1(0, this.node.get$remotePath()).listen$1(new L.ListDefListener_closure(this, callback));
      },
    ...
    ListDefListener_closure: {
      "^": "Closure:41;_requester$_captured_this_0,_requester$_captured_callback_1",
    ...
    ListController: {
      ...
      onUpdate$5: function(streamStatus, updates, columns, meta, error) {
        var t1, t2, t3, t4, t5, t6, t7, t8, reseted, update, t9, t10, $name, value, removed, path, rslt;
        if (updates != null) {
          for (t1 = J.get$iterator$ax(updates), t2 = this.changes, t3 = this.node, t4 = t3.children, t5 = this.requester.nodeCache, t6 = t5._nodes, t7 = t3.attributes, t8 = t3.configs, reseted = false; t1.moveNext$0();) {
            update = t1.get$current();
            t9 = J.getInterceptor(update);
            if (!!t9.$isMap) {
              t10 = t9.$index(update, "name");
              if (typeof t10 === "string")
                $name = t9.$index(update, "name");
              else
                continue;
              if (J.$eq(t9.$index(update, "change"), "remove")) {
                value = null;
                removed = true;
              } else {
                value = t9.$index(update, "value");
                removed = false;
              }
            } else {
              if (!!t9.$isList) {
                if (t9.get$length(update) > 0) {
                  t10 = t9.$index(update, 0);
                  t10 = typeof t10 === "string";
                } else
                  t10 = false;
                if (t10) {
                  $name = t9.$index(update, 0);
                  value = t9.get$length(update) > 1 ? t9.$index(update, 1) : null;
                } else
                  continue;
              } else
                continue;
            ...
            t9 = J.getInterceptor$s($name);
            if (t9.startsWith$1($name, "$")) {
              if (!reseted)
                if (!t9.$eq($name, "$is"))
                  if (!t9.$eq($name, "$base"))
                    t10 = t9.$eq($name, "$disconnectedTs") && typeof value === "string";
                  else
                    t10 = true;
                else
                  t10 = true;
              ...
              if (removed)
                ...
                t8.$indexSet(0, $name, value);
            } else if (t9.startsWith$1($name, "@")) {
              t2.add$1(0, $name);
              if (removed)
                t7.remove$1(0, $name);
              else
                t7.$indexSet(0, $name, value);
            } else {
              t2.add$1(0, $name);
              if (removed)
                t4.remove$1(0, $name);
                ...
                t9 = t3.remotePath;
                path = J.$eq(t9, "/") ? "/" + H.S($name) : H.S(t9) + "/" + H.S($name);
                if (t6.containsKey$1(0, path)) {
                  rslt = t6.$index(0, path);
          ...
          if (!J.$eq(this.request.streamStatus, "initialize"))
            t3.listed = true;
      ...
      loadProfile$1: function(defName) {
        ...
        t2 = this.node;
        t3 = t2.profile;
        if (t3 instanceof L.RemoteNode && J.$eq(H.interceptedTypeCast(t3, "$isRemoteNode").remotePath, defPath))
          return;
        t3 = this.requester;
        t2.profile = t3.nodeCache.getDefNode$2(defPath, defName);
        if (t1.$eq(defName, "node"))
          return;
        t1 = t2.profile;
        if (t1 instanceof L.RemoteNode && !H.interceptedTypeCast(t1, "$isRemoteNode").listed) {
          this._ready = false;
          this._profileLoader = L.ListDefListener$(t1, t3, this.get$_onProfileUpdate());
        }
      },
      _onProfileUpdate$1: [function(update) {
        ...
        this._ready = true;
        this.onProfileUpdated$0();
      }, "call$1", "get$_onProfileUpdate", 2, 0, 42],
      ...
      }, "call$0", "get$onStartListen", 0, 0, 1],
      ...
      }, "call$1", "get$_requester$_onListen", 2, 0, 43],
      _requester$_onAllCancel$0: [function() {
        this._destroy$0();
      }, "call$0", "get$_requester$_onAllCancel", 0, 0, 1],
      _destroy$0: function() {
    ...
    ListController__onListen_closure: {
      ...
      call$0: [function() {
        ...
        t2 = t1.node;
        t3 = t2.configs;
        C.JSArray_methods.addAll$1(changes, t3.get$keys(t3));
        t3 = t2.attributes;
        C.JSArray_methods.addAll$1(changes, t3.get$keys(t3));
        t3 = t2.children;
        C.JSArray_methods.addAll$1(changes, t3.get$keys(t3));
    ...
    RemoveController: {
      "^": "Object;completer,requester,path>,_request",
      get$future: function() {
    ...
    ReqSubscribeListener: {
      "^": "Object;callback,requester,path>",
      cancel$0: function() {
        var t1, t2;
        t1 = this.callback;
        if (t1 != null) {
          t2 = this.requester;
          t2.nodeCache.getRemoteNode$1(this.path)._unsubscribe$2(t2, t1);
          this.callback = null;
        }
        return;
      },
    ...
    SubscribeRequest: {
      "^": "Request;subsriptions,subsriptionids,_changedPaths,toRemove,_requester$_pendingSending,_requester$_waitingAckCount,_requester$_lastWatingAckId,_requester$_sendingAfterAck,requester,rid,data,updater,_requester$_isClosed,streamStatus",
      resend$0: function() {
      ...
      _update$1: function(m) {
        ...
        if (!!t1.$isList)
          for (t1 = t1.get$iterator(updates), t2 = this.subsriptions, t3 = this.subsriptionids; t1.moveNext$0();) {
            ...
            if (path != null && t2.containsKey$1(0, path))
              t2.$index(0, path).addValue$1(O.ValueUpdate$(value, 1, 0 / 0, meta, 0 / 0, null, 0 / 0, ts));
            else if (J.$gt$n(sid, -1) && t3.containsKey$1(0, sid))
      ...
      startSendingData$2: function(currentTime, waitingAckId) {
        var t1, toAdd, processingPaths, t2, t3, path, sub, m, removeSids;
        this._requester$_pendingSending = false;
        if (waitingAckId !== -1) {
          ++this._requester$_waitingAckCount;
          this._requester$_lastWatingAckId = waitingAckId;
        }
        t1 = this.requester;
        if (t1._common$_conn == null)
          return;
        toAdd = [];
        processingPaths = this._changedPaths;
        this._changedPaths = P.HashSet_HashSet(null, null, null, P.String);
        for (t2 = new P.HashSetIterator(processingPaths, processingPaths._computeElements$0(), 0, null), t3 = this.subsriptions; t2.moveNext$0();) {
          path = t2._collection$_current;
          if (t3.containsKey$1(0, path)) {
            sub = t3.$index(0, path);
        ...
        if (t2.__js_helper$_length !== 0) {
          removeSids = [];
          t2.forEach$1(0, new L.SubscribeRequest_startSendingData_closure(this, removeSids));
      ...
      ackReceived$3: function(receiveAckId, startTime, currentTime) {
        if (receiveAckId === this._requester$_lastWatingAckId)
          this._requester$_waitingAckCount = 0;
        else
          --this._requester$_waitingAckCount;
        if (this._requester$_sendingAfterAck) {
      ...
      prepareSending$0: function() {
        if (this._requester$_sendingAfterAck)
          return;
        if (this._requester$_waitingAckCount > 8) {
          this._requester$_sendingAfterAck = true;
          return;
        }
        if (!this._requester$_pendingSending) {
      ...
      static: {SubscribeRequest$: function(requester, rid) {
          var t1 = new L.SubscribeRequest(P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, L.ReqSubscribeController), P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, L.ReqSubscribeController), P.HashSet_HashSet(null, null, null, P.String), P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, L.ReqSubscribeController), false, 0, -1, false, requester, rid, null, new L.SubscribeController(null), false, "initialize");
          t1.SubscribeRequest$2(requester, rid);
          return t1;
        }}
    },
    SubscribeRequest__close_closure: {
      "^": "Closure:44;_requester$_captured_this_0",
    ...
    SubscribeRequest_startSendingData_closure: {
      "^": "Closure:45;_requester$_captured_this_0,_captured_removeSids_1",
      call$2: function(sid, sub) {
        var t1;
        if (sub.get$callbacks().__js_helper$_length === 0) {
          this._captured_removeSids_1.push(sid);
          t1 = this._requester$_captured_this_0;
          t1.subsriptions.remove$1(0, sub.get$node().get$remotePath());
          t1.subsriptionids.remove$1(0, sub.get$sid());
          sub._destroy$0();
        }
      }
    },
    ReqSubscribeController: {
      "^": "Object;node<,requester,callbacks<,maxCache<,sid<,_lastUpdate",
      ...
      addValue$1: function(update) {
        ...
        for (t1 = this.callbacks, t1 = H.setRuntimeTypeInfo(new H.LinkedHashMapKeyIterable(t1), [H.getTypeArgumentByIndex(t1, 0)]), t1 = P.List_List$from(t1, true, H.getRuntimeTypeArgument(t1, "Iterable", 0)), t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i)
    ...
    Requester: {
      "^": "ConnectionHandler;_requests,nodeCache,_subsciption,nextRid,nextSid,lastSentId,_connected,_common$_conn,_connListener,_beforeSendListener,_toSendList,_processors,_pendingSend",
      onData$1: [function(list) {
        ...
        for (t1 = J.get$iterator$ax(list); t1.moveNext$0();) {
          ...
          if (!!t2.$isMap) {
            ...
            if (typeof t3 === "number" && Math.floor(t3) === t3 && this._requests.containsKey$1(0, t2.$index(resp, "rid")))
              this._requests.$index(0, t2.$index(resp, "rid"))._update$1(resp);
          }
        }
      }, "call$1", "get$onData", 2, 0, 46, 55],
      getSendingData$2: function(currentTime, waitingAckId) {
      ...
      subscribe$2: function(path, callback) {
      ...
      closeRequest$1: function(request) {
        ...
        if (t1.containsKey$1(0, t2)) {
          if (!J.$eq(request.streamStatus, "closed"))
      ...
      }, "call$0", "get$onDisconnected", 0, 0, 1],
    ...
    Requester_onDisconnected_closure: {
      "^": "Closure:11;_requester$_captured_this_0,_captured_newRequests_1",
      call$2: function(n, req) {
        if (J.$le$in(req.get$rid(), this._requester$_captured_this_0.lastSentId) && !req.get$updater().$isListController)
    ...
    "^": "",
    ConfigSetting: {
      "^": "Object;name>,type,defaultValue",
      static: {ConfigSetting$fromMap: function($name, m) {
          var t1, t2;
    ...
    Configs: {
      ...
      static: {Configs_getConfig: function($name, profile) {
          var t1 = $.get$Configs_global().configs;
          if (t1.containsKey$1(0, $name))
            return t1.$index(0, $name);
    ...
    Configs_load_closure: {
      "^": "Closure:11;_captured_this_0",
      call$2: function($name, m) {
        if (!!J.getInterceptor(m).$isMap)
          this._captured_this_0.configs.$indexSet(0, $name, T.ConfigSetting$fromMap($name, m));
      }
    },
    NodeProviderImpl: {
      "^": "NodeProvider;"
    ...
    LocalNodeImpl: {
      ...
      setConfig$4: ["super$LocalNodeImpl$setConfig$4", function($name, value, responder, response) {
        var t1, t2, t3;
        t1 = this.configs;
        t2 = T.Configs_getConfig($name, this.profile).name;
      ...
      }, "setValue$3", null, null, "get$setValue", 6, 2, null, 56]
    },
    LocalNodeImpl_load_closure: {
      ...
      call$2: function(key, value) {
        ...
        t1 = J.getInterceptor$s(key);
        if (t1.startsWith$1(key, "$"))
          this._captured_this_1.configs.$indexSet(0, key, value);
        else if (t1.startsWith$1(key, "@"))
    ...
    LocalNode: {
      ...
      }, "call$0", "get$onAllListCancel", 0, 0, 1],
      ...
      setValue$3: function(value, responder, response) {
        return this.setValue$4(value, responder, response, 4);
      },
    ...
    LocalNode_updateValue_closure: {
      ...
      call$2: function(callback, cachelevel) {
        callback.call$1(this._captured_this_0._lastValueUpdate);
      }
    },
    LocalNode_updateValue_closure0: {
      "^": "Closure:11;_captured_this_1",
      call$2: function(callback, cachelevel) {
    ...
    Responder: {
      "^": "ConnectionHandler;reqId,groups,_responses,_responder$_subscription,nodeProvider,_traceCallbacks,_common$_conn,_connListener,_beforeSendListener,_toSendList,_processors,_pendingSend",
      ...
      _onReceiveRequest$1: function(m) {
        ...
        if (t2) {
          t2 = this._responses;
          if (t2.containsKey$1(0, t1.$index(m, "rid"))) {
            if (J.$eq(t1.$index(m, "method"), "close")) {
              t3 = t1.$index(m, "rid");
              if (typeof t3 === "number" && Math.floor(t3) === t3) {
                rid = t1.$index(m, "rid");
                if (t2.containsKey$1(0, rid)) {
                  t2.$index(0, rid)._responder$_close$0();
                  t2.remove$1(0, rid);
                }
              }
            }
      ...
      _closeResponse$2$error: function(rid, error) {
        return this._closeResponse$3$error$response(rid, error, null);
      },
      _closeResponse$1: function(rid) {
      ...
      updateResponse$3$streamStatus: function(response, updates, streamStatus) {
        return this.updateResponse$5$columns$meta$streamStatus(response, updates, null, null, streamStatus);
      },
      updateResponse$2: function(response, updates) {
      ...
      list$1: [function(_, m) {
        ...
        if (path != null)
          t2 = path.name === "/" || J.startsWith$1$s(path.parentPath, "/");
        else
          t2 = false;
        if (t2) {
          rid = t1.$index(m, "rid");
          node = this.nodeProvider.getOrCreateNode$2(path.path, false);
          t1 = new T.ListResponse(node, null, null, P.LinkedHashSet_LinkedHashSet(null, null, null, P.String), true, false, 0, -1, false, this, rid, "initialize", false);
          J.get$path$x(node);
          t1._permission = 4;
      ...
      subscribe$1: function(m) {
        ...
        if (!!J.getInterceptor(t1.$index(m, "paths")).$isList) {
          ...
          for (t2 = J.get$iterator$ax(t1.$index(m, "paths")), t3 = this.nodeProvider; t2.moveNext$0();) {
            ...
            if (path != null)
              t4 = path.name === "/" || J.startsWith$1$s(path.parentPath, "/");
            else
              t4 = false;
            if (t4) {
              node = t3.getOrCreateNode$2(path.path, false);
              this._responder$_subscription.add$4(0, path.path, node, sid, cacheLevel);
            }
          }
        ...
        if (!!J.getInterceptor(t1.$index(m, "sids")).$isList) {
          ...
          for (t2 = J.get$iterator$ax(t1.$index(m, "sids")); t2.moveNext$0();) {
            ...
            if (typeof sid === "number" && Math.floor(sid) === sid)
              this._responder$_subscription.remove$1(0, sid);
          }
          this._closeResponse$1(t1.$index(m, "rid"));
        } else
          this._closeResponse$2$error(t1.$index(m, "rid"), $.get$DSError_INVALID_PATHS());
      ...
      invoke$1: function(m) {
        var t1, path, t2, rid, parentNode, node, maxPermit, permission;
        t1 = J.getInterceptor$asx(m);
        path = O.Path_getValidNodePath(t1.$index(m, "path"), null);
        if (path != null)
          t2 = path.name === "/" || J.startsWith$1$s(path.parentPath, "/");
        ...
        if (t2) {
          ...
          if (typeof maxPermit !== "number")
            return maxPermit.$lt();
          if (maxPermit < 4)
            permission = maxPermit;
          else
            permission = 4;
          t2 = node.getInvokePermission$0();
          if (typeof t2 !== "number")
            return t2.$le();
          if (t2 <= permission)
            node.invoke$5(t1.$index(m, "params"), this, this.addResponse$1(new T.InvokeResponse(parentNode, node, path.name, 0, null, null, "initialize", null, "stream", null, false, null, null, -1, this, rid, "initialize", false)), parentNode, permission);
          else
            this._closeResponse$2$error(t1.$index(m, "rid"), $.get$DSError_PERMISSION_DENIED());
        } else
          this._closeResponse$2$error(t1.$index(m, "rid"), $.get$DSError_INVALID_PATH());
      ...
      $set$1: function(m) {
        var t1, path, t2, value, rid, node, maxPermit, permission;
        t1 = J.getInterceptor$asx(m);
        ...
        if (path.get$isNode()) {
          ...
          node = this.nodeProvider.getOrCreateNode$2(path.parentPath, false);
          J.get$path$x(node);
          ...
          t1.get$path(node);
          t1.setAttribute$4(node, path.name, value, this, this.addResponse$1(new T.Response(this, rid, "initialize", false)));
        } else
          throw H.wrapException("unexpected case");
      },
      remove$1: function(_, m) {
        var t1, path, rid, node;
        t1 = J.getInterceptor$asx(m);
        path = O.Path_getValidPath(t1.$index(m, "path"), null);
    ...
    Response: {
      "^": "Object;responder,rid<,_sentStreamStatus,_pendingSending",
    ...
    InvokeResponse: {
      "^": "Response;parentNode,node<,name>,_pendingInitializeLength,_columns,_updates,_sendingStreamStatus,_meta,type,_err,_responder$_closed,onClose',onAck?,_waitingAckId,responder,rid,_sentStreamStatus,_pendingSending",
      updateStream$4$columns$meta$streamStatus: function(updates, columns, meta, streamStatus) {
        ...
        if (this._sendingStreamStatus === "initialize") {
          t1 = this._pendingInitializeLength;
          t2 = J.get$length$asx(updates);
          if (typeof t2 !== "number")
            return H.iae(t2);
          this._pendingInitializeLength = t1 + t2;
        }
        this._sendingStreamStatus = streamStatus;
        this.prepareSending$0();
      },
      updateStream$2$streamStatus: function(updates, streamStatus) {
      ...
      _responder$_close$0: function() {
        this._responder$_closed = true;
        if (this.onClose != null)
          this.onClose$1(0, this);
      },
      ackReceived$3: function(receiveAckId, startTime, currentTime) {
        if (this.onAck != null && !this._responder$_closed)
          this.onAck$4(this, receiveAckId, startTime, currentTime);
      },
      onClose$1: function($receiver, arg0) {
        return this.onClose.call$1(arg0);
      },
      onAck$4: function(arg0, arg1, arg2, arg3) {
        return this.onAck.call$4(arg0, arg1, arg2, arg3);
      }
    },
    ListResponse: {
      "^": "Response;node<,_nodeChangeListener,_permission,changes<,initialResponse,_disconnectSent,_waitingAckCount,_lastWatingAckId,_sendingAfterAck,responder,rid,_sentStreamStatus,_pendingSending",
      changed$1: [function(key) {
        var t1 = this._permission;
        if (t1 === 0)
          return;
        if (t1 < 4 && J.startsWith$1$s(key, "$$"))
          return;
        t1 = this.changes;
        if (t1._collection$_length === 0) {
          t1.add$1(0, key);
      ...
      startSendingData$2: function(currentTime, waitingAckId) {
        ...
        if (this._disconnectSent && !this.changes.contains$1(0, "$disconnectedTs")) {
          ...
          if (t2.get$configs().containsKey$1(0, "$disconnectedTs"))
            t2.get$configs().remove$1(0, "$disconnectedTs");
        }
        if (this.initialResponse || this.changes.contains$1(0, "$is")) {
          this.initialResponse = false;
          t2.get$configs().forEach$1(0, new T.ListResponse_startSendingData_closure(t1, this, updateConfigs));
          t3 = J.getInterceptor$x(t2);
          t3.get$attributes(t2).forEach$1(0, new T.ListResponse_startSendingData_closure0(updateAttributes));
          ...
          for (t3 = this.changes, t4 = new P.LinkedHashSetIterator(t3, t3._collection$_modifications, null, null), t4._collection$_cell = t3._collection$_first, t3 = J.getInterceptor$x(t2); t4.moveNext$0();) {
            ...
            if (t5.startsWith$1(change, "$")) {
              update = t2.get$configs().containsKey$1(0, change) ? [change, t2.get$configs().$index(0, change)] : P.LinkedHashMap__makeLiteral(["name", change, "change", "remove"]);
              if (this._permission === 4 || !t5.startsWith$1(change, "$$"))
                updateConfigs.push(update);
            } else if (t5.startsWith$1(change, "@"))
              updateAttributes.push(t3.get$attributes(t2).containsKey$1(0, change) === true ? [change, t3.get$attributes(t2).$index(0, change)] : P.LinkedHashMap__makeLiteral(["name", change, "change", "remove"]));
            else
              updateChildren.push(J.containsKey$1$x(t3.get$children(t2), change) ? [change, J.$index$asx(t3.get$children(t2), change).getSimpleMap$0()] : P.LinkedHashMap__makeLiteral(["name", change, "change", "remove"]));
          }
    ...
    SubscribeResponse: {
      "^": "Response;subsriptions,subsriptionids,changed,_waitingAckCount,_lastWatingAckId,_sendingAfterAck,responder,rid,_sentStreamStatus,_pendingSending",
      add$4: function(_, path, node, sid, cacheLevel) {
        ...
        if (t1.$index(0, path) != null) {
          ...
          if (!J.$eq(controller.get$sid(), sid)) {
            ...
            t1.remove$1(0, controller.get$sid());
            J.$eq(controller.get$sid(), sid);
            t1.$indexSet(0, sid, controller);
          }
          controller.set$cacheLevel(cacheLevel);
        } else {
          J.get$path$x(node);
          controller = new T.RespSubscribeController(node, this, null, sid, true, P.ListQueue$(null, O.ValueUpdate), null);
          controller.set$cacheLevel(cacheLevel);
      ...
      remove$1: function(_, sid) {
        ...
        if (t1.$index(0, sid) != null) {
          ...
          t1.remove$1(0, sid);
          this.subsriptions.remove$1(0, J.get$path$x(controller.get$node()));
        }
      },
      startSendingData$2: function(currentTime, waitingAckId) {
        var updates, t1, t2;
    ...
    RespSubscribeController: {
      "^": "Object;node<,response,_listener,sid<,_permitted,lastValues,_cachedLevel",
      ...
      }, "call$1", "get$addValue", 2, 0, 50, 57],
      mergeValues$0: function() {
        var t1, t2, t3, toRemove, rslt, i, rslt0, t4, t5;
        t1 = this.lastValues;
        t2 = t1.get$length(t1);
        t3 = this._cachedLevel;
        if (typeof t3 !== "number")
          return H.iae(t3);
        toRemove = t2 - t3;
        rslt = t1.removeFirst$0();
        for (i = 0; i < toRemove; ++i, rslt = rslt0) {
          t2 = t1.removeFirst$0();
          rslt0 = new O.ValueUpdate(null, null, null, null, 0, null, null);
          t3 = J.getInterceptor$x(t2);
          rslt0.value = t3.get$value(t2);
          rslt0.ts = t2.get$ts();
          rslt0.status = t3.get$status(t2);
          rslt0.count = J.$add$ns(rslt.get$count(), t2.get$count());
          if (!J.get$isNaN$n(rslt.get$sum())) {
            ...
            t4 = 0;
          if (!J.get$isNaN$n(t2.get$sum())) {
            t5 = t2.get$sum();
            if (typeof t5 !== "number")
              return H.iae(t5);
            rslt0.sum = t4 + t5;
          }
          t4 = J.getInterceptor$x(rslt);
          t5 = t4.get$min(rslt);
          rslt0.min = t5;
          if (J.get$isNaN$n(t5) || J.$lt$in(t3.get$min(t2), t5))
            rslt0.min = t3.get$min(t2);
          t4 = t4.get$min(rslt);
          rslt0.max = t4;
          if (J.get$isNaN$n(t4) || J.$gt$n(t3.get$max(t2), t4))
            rslt0.max = t3.get$max(t2);
        }
        t1.addFirst$1(rslt);
      },
      process$0: function() {
        var rslts, t1, t2, lastValue, t3, t4, m;
        rslts = [];
        for (t1 = this.lastValues, t2 = P._ListQueueIterator$(t1); t2.moveNext$0();) {
          lastValue = t2._collection$_current;
          t3 = J.$gt$n(lastValue.get$count(), 1) || J.get$status$x(lastValue) != null;
          t4 = J.getInterceptor$x(lastValue);
          if (t3) {
            m = P.LinkedHashMap__makeLiteral(["ts", lastValue.get$ts(), "value", t4.get$value(lastValue), "sid", this.sid]);
            if (J.$eq(lastValue.get$count(), 0))
              ...
              if (J.get$isFinite$n(t4.get$max(lastValue)))
                m.$indexSet(0, "max", t4.get$max(lastValue));
              if (J.get$isFinite$n(t4.get$min(lastValue)))
                m.$indexSet(0, "min", t4.get$min(lastValue));
            }
            rslts.push(m);
          } else
            rslts.push([this.sid, t4.get$value(lastValue), lastValue.get$ts()]);
        }
        t1.clear$0(0);
        return rslts;
      },
    ...
    AsyncTableResult: {
      "^": "Object;response,columns,rows,status>,meta,onClose',onAck?",
      update$3: function(rows, stat, meta) {
        var t1 = this.rows;
        if (t1 == null)
          this.rows = rows;
        else
          (t1 && C.JSArray_methods).addAll$1(t1, rows);
        this.meta = meta;
        if (stat != null)
          this.status = stat;
        this.write$0();
      },
      update$1: function(rows) {
    ...
    SimpleNodeProvider: {
      "^": "NodeProviderImpl;nodes>,root,defs,sys,_profileFactories,permissions",
      ...
      getOrCreateNode$2: function(path, addToTree) {
        var t1, p, t2, t3, t4, t5, node, pnode;
        t1 = this.nodes;
        if (t1.containsKey$1(0, path))
          return t1.$index(0, path);
        if (addToTree) {
          ...
          t4 = P.LinkedHashMap__makeLiteral(["$is", "node"]);
          t5 = P.LinkedHashMap__makeEmpty();
          node = new T.SimpleNode(this, false, true, false, null, null, path, t2, null, null, t3, t4, t5);
          t1.$indexSet(0, path, node);
          t1 = p.parentPath;
          pnode = t1 !== "" ? this.getNode$1(t1) : null;
          if (pnode != null) {
      ...
      setNode$2: function(path, node) {
        var p, pnode;
        if (path === "/" || !C.JSString_methods.startsWith$1(path, "/"))
          return;
        p = new O.Path(path, null, null, true);
        p._parse$0();
      ...
      addNode$2: function(path, m) {
        var p, pnode, t1, profile, t2, node;
        ...
        t2 = this._profileFactories;
        node = t2.containsKey$1(0, profile) ? t2.$index(0, profile).call$1(path) : this.getOrCreateNode$1(path);
        this.nodes.$indexSet(0, path, node);
        J.load$1$x(node, m);
        node.onCreated$0();
        if (t1) {
    ...
    SimpleNode: {
      "^": "LocalNodeImpl;provider<,removed?,serializable,_loaded,_listChangeController,_listReqListener,path,callbacks,_lastValueUpdate,profile,attributes,configs,children",
      load$1: function(_, m) {
        var t1, t2;
        t1 = {};
        if (this._loaded) {
      ...
      invoke$5: function(params, responder, response, parentNode, maxPermission) {
        var t1, e, stack, error, rslt, t2, exception, t3, rtype, r, list, onError, result;
        t1 = {};
        ...
        t3 = this.configs;
        rtype = t3.containsKey$1(0, "$result") ? t3.$index(0, "$result") : "values";
        if (t2 == null) {
      ...
      setConfig$4: function($name, value, responder, response) {
        this.super$LocalNodeImpl$setConfig$4($name, value, responder, response);
        return response;
      },
      setValue$4: function(value, responder, response, maxPermission) {
        this.super$LocalNodeImpl$setValue$4(value, responder, response, maxPermission);
        return response;
      },
      setValue$3: function(value, responder, response) {
        return this.setValue$4(value, responder, response, 4);
      ...
      $indexSet: function(_, $name, value) {
        ...
        if (t1.startsWith$1($name, "$") || t1.startsWith$1($name, "@"))
          ...
          t2 = t2.path;
          if (t3)
            t2 = J.substring$2$s(t2, 0, t2.length - 1);
          if (typeof t2 !== "string")
            return t2.$add();
          t2 += "/";
          t1 = new O.Path(C.JSString_methods.$add(t2, t1.startsWith$1($name, "/") ? t1.substring$1($name, 1) : $name), null, null, true);
          t1._parse$0();
          tp = t1.path;
    ...
    SimpleNode_invoke_closure0: {
      "^": "Closure:51;_responder$_box_1",
      call$4: function(response, ackId, startTime, currentTime) {
        H.interceptedTypeCast(this._responder$_box_1._captured_rslt_1, "$isAsyncTableResult").onAck;
      }
    },
    ...
    SimpleNode_invoke_closure5: {
      "^": "Closure:11;_captured_response_5",
    ...
    SimpleNode_invoke_closure9: {
      "^": "Closure:11;_captured_response_10",
      call$2: [function(e, stack) {
        var error, exception;
        error = new O.DSError("invokeException", null, J.toString$0(e), null, "response");
        try {
    ...
    SimpleNode_invoke__closure2: {
      "^": "Closure:11;_captured_response_16",
      call$2: [function(e, stack) {
        var error, exception;
        error = new O.DSError("invokeException", null, J.toString$0(e), null, "response");
        try {
    ...
    SimpleHiddenNode: {
      ...
      getSimpleMap$0: function() {
        var rslt, t1;
        rslt = P.LinkedHashMap__makeLiteral(["$hidden", true]);
        t1 = this.configs;
        if (t1.containsKey$1(0, "$is"))
          rslt.$indexSet(0, "$is", t1.$index(0, "$is"));
        if (t1.containsKey$1(0, "$type"))
    ...
    Base64_encode: function(bytes, lineSize, paddingSpace) {
      var len, remainderLength, chunkLength, t1, outputLen, lineSizeGroup, t2, out, j, i, j0, t3, c, i0, t4, t5, x, y;
      len = bytes.length;
      if (len === 0)
        return "";
      ...
      for (t2 = out.length, j = 0, i = 0; i < paddingSpace; ++i, j = j0) {
        j0 = j + 1;
        if (j >= t2)
          return H.ioore(out, j);
        out[j] = 32;
      }
      for (t3 = outputLen - 2, i = 0, c = 0; i < chunkLength; i = i0) {
        i0 = i + 1;
        if (i >= len)
          return H.ioore(bytes, i);
        t4 = C.JSInt_methods.$mod(bytes[i], 256);
        i = i0 + 1;
        if (i0 >= len)
          return H.ioore(bytes, i0);
        t5 = C.JSInt_methods.$mod(bytes[i0], 256);
        i0 = i + 1;
        if (i >= len)
          return H.ioore(bytes, i);
        x = t4 << 16 & 16777215 | t5 << 8 & 16777215 | C.JSInt_methods.$mod(bytes[i], 256);
        j0 = j + 1;
        t5 = C.JSString_methods.codeUnitAt$1("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", x >>> 18);
        if (j < 0 || j >= t2)
          return H.ioore(out, j);
        out[j] = t5;
        j = j0 + 1;
        t5 = C.JSString_methods.codeUnitAt$1("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", x >>> 12 & 63);
        if (j0 < 0 || j0 >= t2)
          return H.ioore(out, j0);
        out[j0] = t5;
        j0 = j + 1;
        t5 = C.JSString_methods.codeUnitAt$1("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", x >>> 6 & 63);
        if (j < 0 || j >= t2)
          return H.ioore(out, j);
        out[j] = t5;
        j = j0 + 1;
        t5 = C.JSString_methods.codeUnitAt$1("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_", x & 63);
        if (j0 < 0 || j0 >= t2)
          return H.ioore(out, j0);
        out[j0] = t5;
        if (t1) {
    ...
    }, "call$0", "DsTimer__startTimer$closure", 0, 0, 1],
    ...
    DsTimer__removeTimerFunctions: function(time50) {
      ...
      if (t1) {
        ...
        t2.unlink$0();
        for (t1 = t2.get$_functions(), t3 = t1.length, _i = 0; _i < t1.length; t1.length === t3 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          fun = t1[_i];
    ...
    DsTimer_timerOnceAfter: function(callback, ms) {
      var desiredTime50, existTf, t1, tf;
    ...
    }, "call$0", "DsTimer__dsLoop$closure", 0, 0, 1],
    logger: function() {
      var t1 = $._logger;
      if (t1 != null)
        return t1;
    ...
    buildEnumType: function(values) {
      return "enum[" + C.JSArray_methods.join$1(values, ",") + "]";
    },
    closure2: {
      "^": "Closure:0;",
      call$0: function() {
    ...
    BinaryInCache: {
      ...
      receiveData$1: function(inputList) {
        var t1, t2, t3, bytedata, headerSize, end, i, start, end0, t4, t5, bytes, id, finished, data;
        t1 = inputList.buffer;
        t2 = inputList.byteOffset;
        t3 = inputList.byteLength;
        t1.toString;
        bytedata = H.NativeByteData_NativeByteData$view(t1, t2, t3);
    ...
    BinaryOutCache: {
      ...
      export$0: function() {
        ...
        t3.toString;
        idToRemove = [];
        t2.forEach$1(0, new Q.BinaryOutCache_export_closure0(t1, output, H.NativeByteData_NativeByteData$view(t3, 0, null), idToRemove));
    ...
    BinaryOutCache_export_closure0: {
      "^": "Closure:52;_utils$_box_0,_captured_output_1,_captured_bytedata_2,_captured_idToRemove_3",
      call$2: function(id, data) {
        var t1, t2, t3, t4;
    ...
    DsJsonCodecImpl: {
      ...
      static: {DsJsonCodecImpl__safeEncoder: [function(value) {
          return;
        }, "call$1", "DsJsonCodecImpl__safeEncoder$closure", 2, 0, 2, 17]}
    },
    DsJsonCodecImpl_decodeJsonFrame__reviver: {
      "^": "Closure:11;_captured_cache_0",
      call$2: function(key, value) {
    ...
    BroadcastStreamController: {
      ...
      static: {BroadcastStreamController$: function(onStartListen, onAllCancel, onListen, $T) {
          var t1 = H.setRuntimeTypeInfo(new Q.BroadcastStreamController(P.StreamController_StreamController(null, null, null, null, false, $T), null, null, null, false, false, false), [$T]);
    ...
    TimerFunctions: {
      "^": "LinkedListEntry;ts50<,_functions<,_list,_collection$_next,_collection$_previous",
      add$1: function(_, foo) {
        var t1 = this._functions;
        if (!C.JSArray_methods.contains$1(t1, foo))
          t1.push(foo);
      },
      remove$1: function(_, foo) {
        C.JSArray_methods.remove$1(this._functions, foo);
      }
    },
    ...
    convertNativeToDart_AcceptStructuredClone_findSlot: {
      "^": "Closure:54;_captured_values_0,_captured_copies_1",
      call$1: function(value) {
        var t1, $length, i, t2;
    ...
    Device: {
      ...
      get$platform: function(_) {
        return J.$index$asx(this._device, "platform");
      },
      ...
      static: {Device__enableDevice: function() {
          ...
          t1 = new O.Device__enableDevice_doWhenDeviceReady(cmpl);
          if (J.$index$asx($.get$context(), "device") == null) {
            t2 = document;
            C.HtmlDocument_methods._addEventListener$3(t2, "deviceready", t1, null);
          } else
            t1.call$1("");
          return cmpl.future;
        }}
    ...
    Device__enableDevice_doWhenDeviceReady: {
      "^": "Closure:13;_captured_cmpl_0",
      call$1: [function(_) {
        var ex, st, t1, t2, exception;
        try {
          t1 = new O.Device(null);
          t2 = J.$index$asx($.get$context(), "device");
          t1._device = t2;
          if (t2 == null)
            H.throwExpression(new P.StateError("Device not ready."));
          $.device = t1;
          this._captured_cmpl_0.complete$1(0, t1);
        } catch (exception) {
          t1 = H.unwrapException(exception);
          ex = t1;
          st = H.getTraceFromException(exception);
          this._captured_cmpl_0.completeError$2(ex, st);
        }
      }, null, null, 2, 0, null, 29, "call"]
    }
  }]];
  ...
  C.C_NullNodeValidator = new L.NullNodeValidator();
...
;
  ...
  (function(lazies) {
  ...
  }, "undefinedLiteralPropertyPattern", "BigInteger_useJsBigint", "get$BigInteger_useJsBigint", function() {
    return new Z.closure1().call$0();
  }, "useJsBigint", "SecureRandom_registry", "get$SecureRandom_registry", function() {
    return new F.Registry(P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.Function), H.setRuntimeTypeInfo([], [P.Function]));
  ...
  }, "_MASK32_HI_BITS", "_AsyncRun_scheduleImmediateClosure", "get$_AsyncRun_scheduleImmediateClosure", function() {
  ...
  }, "_dartProxyCtor", "LocalDataStorage_INSTANCE", "get$LocalDataStorage_INSTANCE", function() {
    return new Y.LocalDataStorage();
  }, "INSTANCE", "DSError_PERMISSION_DENIED", "get$DSError_PERMISSION_DENIED", function() {
    ...
    return new G.closure0().call$0();
  }, "_secp256r1", "DartCryptoProvider_INSTANCE", "get$DartCryptoProvider_INSTANCE", function() {
    var t1 = new G.DSRandomImpl(null, null);
    t1.DSRandomImpl$1(-1);
    return new G.DartCryptoProvider(t1, null, null, -1);
  ...
  }, "nameMap", "Configs_global", "get$Configs_global", function() {
  ...
  }, "_functionsMap", "Logger__loggers", "get$Logger__loggers", function() {
    return P.LinkedHashMap_LinkedHashMap$_empty(P.String, N.Logger);
  }, "_loggers"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = ["invocation", "object", "sender", "e", "x", "closure", "isolate", "numberOfArguments", "arg1", "arg2", "arg3", "arg4", "error", "stackTrace", "result", "each", "key", "value", "a", "i", "w", "j", "c", "n", "p", "k", "preCompInfo", "y", null, "_", "data", "ignored", "element", "arg", "entry", 0, "byteString", "attributeName", "context", "position", "v", "attr", "callback", "captureThis", "self", "arguments", "o", true, "reconnect", "channel", "authError", "conn", "record", "params", "update", "list", 4, "val", "stack", "subscription"];
  init.types = [{func: 1}, {func: 1, void: true}, {func: 1, args: [,]}, {func: 1, args: [P.String,,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.$int}, {func: 1, ret: Z.BigIntegerDartvm, args: [Z.BigIntegerDartvm]}, {func: 1, args: [,,,,,,]}, {func: 1, ret: Z.BigIntegerV8, args: [Z.BigIntegerV8]}, {func: 1, args: [,,]}, {func: 1, args: [P.$int]}, {func: 1, void: true, args: [,]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, ret: P.Future}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.bool}, {func: 1, args: [P.bool]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, ret: P.$int, args: [, P.$int]}, {func: 1, void: true, args: [P.$int, P.$int]}, {func: 1, args: [P.Symbol,,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, void: true, args: [P.String]}, {func: 1, void: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, void: true, args: [W.Node, W.Node]}, {func: 1, opt: [P.bool]}, {func: 1, void: true, args: [P.Timer]}, {func: 1, void: true, args: [W.Event]}, {func: 1, void: true, args: [W.MessageEvent]}, {func: 1, void: true, opt: [P.Object]}, {func: 1, void: true, args: [O.ConnectionChannel]}, {func: 1, ret: P.Future, args: [[P.Map, P.String,,]]}, {func: 1, args: [P.JsObject]}, {func: 1, args: [P.String, P.Map]}, {func: 1, args: [P.String, P.Object]}, {func: 1, args: [L.RequesterListUpdate]}, {func: 1, void: true, args: [L.RequesterListUpdate]}, {func: 1, void: true, args: [{func: 1, args: [,]}]}, {func: 1, args: [P.String, L.ReqSubscribeController]}, {func: 1, args: [P.$int, L.ReqSubscribeController]}, {func: 1, void: true, args: [P.List]}, {func: 1, ret: [P.Stream, L.RequesterListUpdate], args: [P.String]}, {func: 1, void: true, args: [P.Map]}, {func: 1, args: [, T.LocalNode]}, {func: 1, void: true, args: [O.ValueUpdate]}, {func: 1, args: [T.InvokeResponse, P.$int, P.$int, P.$int]}, {func: 1, args: [P.$int, Q.BinaryData]}, {func: 1, args: [P.Function]}, {func: 1, ret: P.$int, args: [,]}, {func: 1, args: [P.$int,,]}, {func: 1, ret: E.ECPoint, args: [E.ECPoint, Z.BigInteger, S.PreCompInfo]}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, ret: P.bool, args: [,,]}, {func: 1, ret: P.Object, args: [,]}, {func: 1, ret: P.bool, args: [P.Object, P.Object]}, {func: 1, ret: P.$int, args: [P.Object]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}];
